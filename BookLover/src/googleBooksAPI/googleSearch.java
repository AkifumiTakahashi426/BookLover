...
public class googleSearch {
    ...
    public List<Book> search(String identifierS, String titleS) {
        ...
        if (identifier.equals("")) {
            // 書名等で検索
            requestUrl = "https://www.googleapis.com/books/v1/volumes?q=intitle:" + "アイシールド21";
        ...
        try {
            ...
            for (int i = 0; i < count; i++) {
                ...
                Book book = new Book(booktitle, publisher, authors, thumbnail, identifier, selfLink, description, fun,
                        summary, alreadyRead, have);
